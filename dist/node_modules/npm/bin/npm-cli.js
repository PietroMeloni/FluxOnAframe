...
;(function () {
  ...
  npm.load(conf, function (er) {
    ...
    if (npm.config.get('update-notifier') && !unsupported.checkVersion(process.version).unsupported) {
      var pkg = require('../package.json');
      var notifier = require('update-notifier')({ pkg: pkg });
      if (notifier.update && notifier.update.latest !== pkg.version) {
        var color = require('ansicolors');
        var useColor = npm.config.get('color');
        var useUnicode = npm.config.get('unicode');
        ...
        var changelog = 'https://github.com/npm/cli/releases/tag/v' + latest;
        notifier.notify({
