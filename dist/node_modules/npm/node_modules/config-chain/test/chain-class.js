...
test('basic class test', function (t) {
  var cc = new CC();
  var expectlist = [{ blaz: 'json', json: true }, { 'x.y.z': 'xyz', blaz: 'ini' }, { blaz: 'blzaa', env: 'myenv' }, { blaz: 'http', http: true, json: true }, { blaz: 'http', http: true, ini: true, json: false }];
...
//# sourceMappingURL=chain-class.js.map