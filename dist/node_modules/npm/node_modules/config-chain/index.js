...
var find = _exports.find = function () {
...
var parse = _exports.parse = function (content, file, type) {
  content = '' + content;
...
var json = _exports.json = function () {
...
var env = _exports.env = function (prefix, env) {
  env = env || process.env;
  var obj = {};
  var l = prefix.length;
  for (var k in env) {
...
_exports.ConfigChain = ConfigChain;
...
ConfigChain.prototype.addEnv = function (prefix, env, name) {
  name = name || 'env';
  var data = _exports.env(prefix, env);
...
ConfigChain.prototype.add = function (data, marker) {
  if (marker && (typeof marker === 'undefined' ? 'undefined' : _typeof(marker)) === 'object') {
...
ConfigChain.prototype.parse = _exports.parse;
