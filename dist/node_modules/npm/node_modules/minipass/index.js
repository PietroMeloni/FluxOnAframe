...
var SILENT_END = Symbol('silentEnd');
  ...
  _createClass(MiniPass, [{
    ...
    value: function on(ev, fn) {
      try {
        ...
        if (ev === 'data' && !this.pipes.length && !this.flowing) this[RESUME]();else if (ev === 'end' && this[SILENT_END] && this[EMITTED_END]) {
    ...
    value: function emit(ev, data) {
      ...
      try {
        var ret = _get(MiniPass.prototype.__proto__ || Object.getPrototypeOf(MiniPass.prototype), 'emit', this).apply(this, args);
        if (ev === 'end' && ret === false) this[SILENT_END] = true;
        return ret;
      } finally {
