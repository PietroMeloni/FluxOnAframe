...
function PacoteOptions(opts) {
  ...
  this.isFromCI = !!(opts.isFromCI || process.env['CI'] === 'true' || process.env['TDDIUM'] || process.env['JENKINS_URL'] || process.env['bamboo.buildKey']);
  ...
  this.includeDeprecated = opts.includeDeprecated == null ? true : opts.includeDeprecated;
...
//# sourceMappingURL=opt-check.js.map