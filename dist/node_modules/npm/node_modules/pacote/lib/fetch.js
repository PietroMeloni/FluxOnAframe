...
var duck = require('protoduck');

var Fetcher = duck.define(['spec', 'opts', 'manifest'], {
  manifest: ['spec', 'opts'],
  tarball: ['spec', 'opts'],
  fromManifest: ['manifest', 'spec', 'opts'],
  clearMemoized: function clearMemoized() {}
}, { name: 'Fetcher' });
module.exports = Fetcher;

module.exports.manifest = manifest;
function manifest(spec, opts) {
  var fetcher = getFetcher(spec.type);
...
function clearMemoized() {
  Object.keys(fetchers).forEach(function (k) {
