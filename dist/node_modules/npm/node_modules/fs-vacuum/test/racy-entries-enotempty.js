...
var _readdir = require('graceful-fs').readdir;
var readdirSync = require('graceful-fs').readdirSync;
var _rmdir = require('graceful-fs').rmdir;
...
var vacuum = requireInject('../vacuum.js', {
  'graceful-fs': {
    ...
    'rmdir': function rmdir(dir, cb) {
      _rmdir(dir, function (err) {
...
//# sourceMappingURL=racy-entries-enotempty.js.map