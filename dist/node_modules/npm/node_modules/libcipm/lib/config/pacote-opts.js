...
function pacoteOpts(npmOpts, moreOpts) {
  ...
  (npmOpts.forEach ? Array.from(npmOpts.keys()) : npmOpts.keys).forEach(function (k) {
  ...
  Object.keys(moreOpts || {}).forEach(function (k) {
    opts[k] = moreOpts[k];
  });
...
//# sourceMappingURL=pacote-opts.js.map