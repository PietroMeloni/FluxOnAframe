...
function putData(cache, key, data, opts) {
  ...
  return write(cache, data, opts).then(function (res) {
    return index.insert(cache, key, res.integrity, opts.concat({ size: res.size })).then(function (entry) {
      if (opts.memoize) {
...
function putStream(cache, key, opts) {
  ...
  var stream = to(function (chunk, enc, cb) {
    ...
    contentStream.end(function () {
      index.insert(cache, key, integrity, opts.concat({ size: size })).then(function (entry) {
        if (opts.memoize) {
