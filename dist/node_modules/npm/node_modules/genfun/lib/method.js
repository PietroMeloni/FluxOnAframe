...
function Method(genfun, selector, func) {
  ...
  var tmpSelector = selector.length ? selector : [Object.prototype];
    ...
    if (i > 0 && !method.minimalSelector && util.isObjectProto(object)) {
      ...
      if (!Object.hasOwnProperty.call(object, Role.roleKeyName)) {
        if (Object.defineProperty) {
          ...
          Object.defineProperty(object, Role.roleKeyName, { value: [], enumerable: false });
        } else {
...
Method.setRankHierarchyPosition = function (method, index, hierarchyPosition) {
  method._rank[index] = hierarchyPosition;
};

Method.clearRank = function (method) {
  method._rank = [];
};

Method.isFullySpecified = function (method) {
...
Method.score = function (method) {
  // TODO - this makes all items in the list equal
  return method._rank.reduce(function (a, b) {
    return a + b;
  }, 0);
};
