...
var SmartBuffer = function () {
    ...
    function SmartBuffer(arg1, arg2) {
        var type;
        switch (type = typeof arg1 === 'undefined' ? 'undefined' : _typeof(arg1)) {
            case 'number':
    ...
    var makeReader = function makeReader(func, size) {
        return function () {
    ...
    var makeWriter = function makeWriter(func, size) {
    ...
    SmartBuffer.prototype.writeString = function (value, offset, encoding) {
        var len,
            _offset,
            type = typeof offset === 'undefined' ? 'undefined' : _typeof(offset);
...
//# sourceMappingURL=smart-buffer.js.map