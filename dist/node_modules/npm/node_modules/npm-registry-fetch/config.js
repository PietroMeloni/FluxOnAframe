...
var silentLog = require('./silentlog.js');

var AUTH_REGEX = /^(?:.*:)?(_authToken|username|_password|password|email|always-auth|_auth|otp)$/;
var SCOPE_REGISTRY_REGEX = /@.*:registry$/gi;
var RegFetchConfig = pudding({
  'agent': {},
  'algorithms': {},
  'body': {},
  'ca': {},
