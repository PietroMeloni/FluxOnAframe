...
function readInstalled_(folder, parent, name, reqver, depth, opts, cb) {
  ...
  function next(er) {
    ...
    debug('next', installed, obj && (typeof obj === "undefined" ? "undefined" : _typeof(obj)), name, real);
...
function resolveInheritance(obj, opts) {
  ...
  riSeen.push(obj);
  if (_typeof(obj.dependencies) !== "object") {
    obj.dependencies = {};
  }
  ...
  Object.keys(obj.dependencies).forEach(function (dep) {
    if (_typeof(obj.dependencies[dep]) === "object") {
...
function findDep(obj, d) {
  ...
  while (r && !found) {
    ...
    if (_typeof(r.dependencies[d]) === "object") {
...
//# sourceMappingURL=read-installed.js.map