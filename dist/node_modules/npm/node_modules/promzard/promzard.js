...
PromZard.prototype.loaded = function () {
  ...
  if (res && (typeof res === 'undefined' ? 'undefined' : _typeof(res)) === 'object' && exports === mod.exports && Object.keys(exports).length === 1) {
    this.result = res;
  } else {
...
PromZard.prototype.makePrompt = function () {
  ...
  function prompt() {
    ...
    for (var i = 0; i < arguments.length; i++) {
      var a = arguments[i];
      if (typeof a === 'string' && p) d = a;else if (typeof a === 'string') p = a;else if (typeof a === 'function') t = a;else if (a && (typeof a === 'undefined' ? 'undefined' : _typeof(a)) === 'object') {
        p = a.prompt || p;
        d = a.default || d;
        t = a.transform || t;
      }
  ...
  function L() {
    ...
    while (i < len) {
      ...
      if (v && (typeof v === 'undefined' ? 'undefined' : _typeof(v)) === 'object') {
        ...
        // default to the key
        if (undefined === prompt[0]) prompt[0] = k;

        // default to the ctx value, if there is one
        if (undefined === prompt[1]) prompt[1] = this.ctx[k];
...
//# sourceMappingURL=promzard.js.map