...
module.exports = {
  ...
  "directories": function directories(cb) {
  ...
  "dependencies": typeof dependencies !== 'undefined' ? dependencies : function (cb) {
    fs.readdir('node_modules', function (er, dir) {
      ...
      dir.forEach(function (d) {
        ...
        if (d.match(/^(expresso|mocha|tap|coffee-script|coco|streamline)$/)) return next();
  ...
  "scripts": function () {
    ...
    if (d.indexOf('coffee-script') !== -1) s.prepublish = prompt('build command', s.prepublish || 'coffee src/*.coffee -o lib');
    ...
    if (!s.test || s.test === notest) {
      if (d.indexOf('tap') !== -1) s.test = prompt('test command', 'tap test/*.js', tx);else if (d.indexOf('expresso') !== -1) s.test = prompt('test command', 'expresso test', tx);else if (d.indexOf('mocha') !== -1) s.test = prompt('test command', 'mocha', tx);else s.test = prompt('test command', tx);
    }
  ...
  "repository": function () {
    ...
    if (gconf) {
      ...
      if (u && u.match(/^git@github.com:/)) u = u.replace(/^git@github.com:/, 'git://github.com/');
    }
