...
var url = void 0;
var HostedGit = void 0;
var semver = void 0;
var path = void 0;
var validatePackageName = void 0;
var osenv = void 0;
...
function resolve(name, spec, where, arg) {
  ...
  var hosted = HostedGit.fromUrl(spec, { noGitPlus: true, noCommittish: true });
  if (hosted) {
...
function fromFile(res, where) {
  ...
  var spec = res.rawSpec.replace(/\\/g, '/').replace(/^file:[/]*([A-Za-z]:)/, '$1') // drive name paths on windows
  .replace(/^file:(?:[/]*([~./]))?/, '$1');
  if (/^~[/]/.test(spec)) {
