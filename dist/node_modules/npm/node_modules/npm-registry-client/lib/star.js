...
function star(uri, params, cb) {
  ...
  assert(params && (typeof params === 'undefined' ? 'undefined' : _typeof(params)) === 'object', 'must pass params to star');
  assert(typeof cb === 'function', 'must pass callback to star');

  var starred = !!params.starred;

  var auth = params.auth;
  assert(auth && (typeof auth === 'undefined' ? 'undefined' : _typeof(auth)) === 'object', 'must pass auth to star');
