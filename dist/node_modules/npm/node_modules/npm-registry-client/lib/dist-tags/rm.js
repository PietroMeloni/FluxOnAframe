...
function rm(uri, params, cb) {
  ...
  assert(params && (typeof params === 'undefined' ? 'undefined' : _typeof(params)) === 'object', 'must pass params to distTags.rm');
  ...
  assert(params.auth && _typeof(params.auth) === 'object', 'must pass auth to distTags.rm');
