...
function fetch(uri, params, cb) {
  ...
  assert(params && (typeof params === 'undefined' ? 'undefined' : _typeof(params)) === 'object', 'must pass params to distTags.fetch');
  ...
  assert(params.auth && _typeof(params.auth) === 'object', 'must pass auth to distTags.fetch');
  ...
  this.request(url.resolve(uri, rest), options, function (er, data) {
    if (data && (typeof data === 'undefined' ? 'undefined' : _typeof(data)) === 'object') delete data._etag;
    cb(er, data);
  });
}
