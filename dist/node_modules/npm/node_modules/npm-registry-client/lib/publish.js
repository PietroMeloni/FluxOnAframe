...
function publish(uri, params, cb) {
  ...
  assert(params && (typeof params === 'undefined' ? 'undefined' : _typeof(params)) === 'object', 'must pass params to publish');
  ...
  assert(auth && (typeof auth === 'undefined' ? 'undefined' : _typeof(auth)) === 'object', 'must pass auth to publish');
  ...
  assert(metadata && (typeof metadata === 'undefined' ? 'undefined' : _typeof(metadata)) === 'object', 'must pass package metadata to publish');
  try {
